...
class Follow(db.Model):
    ...
    followed_user = relationship('Account', foreign_keys=[followed_user_id], backref="followers_list")
    follower = relationship('Account', foreign_keys=[user_id], backref="follows")
